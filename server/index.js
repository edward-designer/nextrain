...
app.get("/api/:from/to/:to/:timeOffset", (request, response) => {
  ...
  const URL1 = `https://huxley2.azurewebsites.net/departures/${request.params.from}${to}/20?accessToken=${process.env.ACCESSTOKEN}&expand=true&timeOffset=${timeOffset}&timeWindow=120`;
  const URL2 = `https://huxley2.azurewebsites.net/arrivals/${request.params.to}/from/${request.params.from}/20?accessToken=${process.env.ACCESSTOKEN}&expand=true&timeOffset=${timeOffset2}&timeWindow=120`;
